...
class StandaloneOrchestrator:
    ...
    async def _summarize(self, mr_data, changes_data):
    ...
    async def _send_summary(self, project_id, mr_iid, summary, email_date):
    ...
    async def process_merge_request(self, mr_url: str, email_subject: str = "", email_date: str = "") -> bool:
        ...
        try:
            ...
            summary = await self._summarize(mr_data=mr_data, changes_data=changes_data)
            logger.info(f"Generated summary ({len(summary)} chars)")

            post_data = await self._send_summary(
                project_id=project_id,
                mr_iid=mr_iid,
                summary=summary,
